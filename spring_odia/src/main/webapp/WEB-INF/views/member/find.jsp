...
<style>
	...
	.find .box-tabs li{
		border: 1px solid #dee2d6; border-top: none; min-height: 300px;
	}
</style>
</head>
<body>
	<div class="container find body">
	 <ul class="nav nav-tabs">
	    ...
	    <li class="nav-item">
	      <a class="nav-link" href="#" data-target="#pwBox">비밀번호 찾기</a>
	    </li>
	  </ul>
	  <ul class="box-tabs">
		  <li id="idBox">
		  	...
		  	<div class="form-group">
		  	 <input type="text" class="form-control" palceholder="이메일" name="me_email">
		  	</div>
		  	<div class="form-group">
		  	 <input type="text" class="form-control" palceholder="이름" name="me_name">
		  	</div>
		  ...
		  <li id="pwBox">
		  	...
		  	<div class="form-group">
		  	 <input type="text" class="form-control" palceholder="아이디" name="me_id">
		  	</div>
...
$('.find .nav-tabs a').first().click(); //처음 페이지 접속했을 때부터 li가 하나만 보이게 
</script>
</body>
</html>