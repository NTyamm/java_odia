...
<body>
	<form class="container signup body" action="<%=request.getContextPath()%>/mypage" method="post">
		...
		<div class="form-group">
			...
			<input type="password" class="form-control" placeholder="비밀번호수정" name="me_pw">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<div class="form-check-inline"> <!-- c:if test로 checked 넣어주기..? 스크립트에서 ajax로? -->
