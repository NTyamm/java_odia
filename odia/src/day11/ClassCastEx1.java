...
public class ClassCastEx1 {
	...
	public static void main(String[] args) {
		...
		double num2 = num;
		//num와 num2가 다른 저료형이고, num2의 자료형인 double이 int로 자동형변환이 불가능하여
		//명시적 형변환을 통해 int로 일시적으로 변환
		num = (int)num2;
		//클래스와 일치하는 객체를 생성하여 저장
		C2 c = new C2();
		P2 p = new P2();
		//자식클래스의 객체를 부모 클래스의 객체로 자동 형변환할 수 있다
		P2 parent = new C2();
		parent.print();
		//C2를 이용하여 객체를 만들었지만 P2에는 hello 메소드가 없기 때문에 호출할 수 없다.
		//parent.hello();
		C2 child1 = new C2();
		P2 parent2 = child1;
		parent2.print();
