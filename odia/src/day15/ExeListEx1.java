...
public class ExeListEx1 {
	...
	public static void main(String[] args) {
		...
		//get(index)은 index번지에 있는 객체를 가져오는 기능
		//get()은 list 에만 있고, set은 없음
		...
		//remove(1)을 하면 1과 일치하는 객체를 제거하는 게 아니라 1번지에 있는 객체를 제거
		...
		System.out.println("1이 list에 있나요? : " + list1.contains(1));
		System.out.println("5이 list에 있나요? : " + list1.contains(5));
		//indexOf : 리스트에 객체와 일치하는 객체가 있으면 번지를 없으면 -1을 알려주는 기능
		System.out.println("1이 list에 있나요? : " + list1.indexOf(1));
		System.out.println("5이 list에 있나요? : " + list1.indexOf(5));
	}
